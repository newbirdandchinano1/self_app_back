...
const COLUMN_LABELS = {
  ...
  target_protein:'目标蛋白质', sodium:'钠', target_sodium:'目标钠', carbohydrate:'碳水化合物', target_carbohydrate:'目标碳水', calories:'摄入热量',
  target_calories:'目标热量', day_ymd:'逻辑日', rationale_zh:'目标说明', source:'来源', quick_add_key:'快捷添加键', intake_display_title:'摄入标题', intake_ai_comment:'摄入AI点评',
