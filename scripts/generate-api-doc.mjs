...
const COLUMN_LABELS = {
  ...
  target_protein:'目标蛋白质', carbohydrate:'碳水化合物', target_carbohydrate:'目标碳水', sodium:'钠',
  target_sodium:'目标钠', quick_add_key:'快捷添加键', intake_display_title:'摄入标题', intake_ai_comment:'摄入AI点评',
