-- 任务域全局标签（一期）：字典 tags + 多态关联 tag_links
-- 幂等；保留旧表 project_tags / project_tag_links，启动时 ensure 也会再跑一遍迁移。
...
CREATE TABLE IF NOT EXISTS `tag_links` (
  `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `entity_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'project|habit|task',
